---
name: legal-employment-handbook-updates
...
the project legal profile → handbook location, state supplements list, update cadence.
...
For each state supplement in the project legal profile:
