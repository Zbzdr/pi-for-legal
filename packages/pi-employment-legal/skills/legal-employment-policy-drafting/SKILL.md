---
name: legal-employment-policy-drafting
...
1. Load the project legal profile → jurisdictional footprint, handbook location.
...
the project legal profile → jurisdictional footprint, handbook location and format.
