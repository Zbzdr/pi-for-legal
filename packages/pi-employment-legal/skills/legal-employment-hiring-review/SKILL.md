---
name: legal-employment-hiring-review
...
1. Load the project legal profile → jurisdictional footprint, hiring review triggers, restrictive covenant policy.
...
the project legal profile → jurisdictional footprint, hiring review triggers, restrictive
...
Check the jurisdiction table in the project legal profile for this state/country. If it's
...
Per the project legal profile restrictive covenant policy: does this hire even get one?
...
Check the the project legal profile table for this jurisdiction. Common categories to
...
**Before producing a "Clear to send" recommendation or a final offer letter for signature:** Read `## Who's using this` in the project legal profile. If the Role is **Non-lawyer**:
