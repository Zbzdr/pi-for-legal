...
2. Identify the tracker file: `<dataDir>/employment-legal/expansion-[slug].yaml`. If it doesn't
   exist, respond: "No expansion tracker found for [country]. Run
   `/skill:legal-employment-expansion-kickoff [country]` to start one."
...
```
/skill:legal-employment-expansion-update Germany
```
