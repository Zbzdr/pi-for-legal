---
name: legal-employment-international-expansion
...
Read the project legal profile → jurisdictional footprint, escalation table, any existing
expansion notes.
...
Write a new file to `<dataDir>/employment-legal/expansion-[country-slug].yaml` with all open items
...
**Roles:** [list]
**Tracker:** <dataDir>/employment-legal/expansion-[slug].yaml
...
Run `/skill:legal-employment-expansion-update [country]` to update status
as items close.
```
