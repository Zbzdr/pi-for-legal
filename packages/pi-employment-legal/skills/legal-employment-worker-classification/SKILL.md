---
name: legal-employment-worker-classification
...
Read the project legal profile → jurisdictional footprint, any classification history or
...
If the project legal profile records the company's house classification policy, apply it
...
Escalate per the project legal profile if any of the following, or any team-specific
...
`/skill:legal-employment-hiring-review` to review the offer letter, restrictive
...
**Before producing a "Proceed as IC / employee / agency / vendor" final recommendation:** Read `## Who's using this` in the project legal profile. If the Role is **Non-lawyer**:
