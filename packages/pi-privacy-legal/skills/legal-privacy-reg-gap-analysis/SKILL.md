...
1. Load the project legal profile → privacy policy commitments, regulatory footprint, DSAR systems.
...
```
/skill:legal-privacy-reg-gap-analysis "Colorado Privacy Act"
```
...
This skill diffs the new requirement against what you currently do (per the project legal profile → Privacy policy commitments + the practices documented in PIAs) and produces a gap list with a remediation plan.
...
**We currently:** [what the config project legal profile / privacy policy / practice shows]
