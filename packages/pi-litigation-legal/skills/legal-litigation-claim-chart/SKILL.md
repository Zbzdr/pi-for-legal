...
1. Load the project legal profile → role, work-product header, decision posture, document storage.
...
- the project legal profile → role, work-product header, decision posture, document storage, case-theory scaffolding
...
If `project legal profile` has `[PLACEHOLDER]` markers, surface this bounce:
