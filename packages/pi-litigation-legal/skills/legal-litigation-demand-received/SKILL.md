...
6. Write `<dataDir>/litigation-legal/inbound/[slug]/triage.md`. Copy or link incoming to `<dataDir>/litigation-legal/inbound/[slug]/incoming.[ext]`.
...
- **Leverage and pressure** — are they credibly prepared to sue? Do they have capacity? Are they a repeat-litigant adversary per the project legal profile?
...
- Standalone → leave in `<dataDir>/litigation-legal/inbound/`; no portfolio change.
