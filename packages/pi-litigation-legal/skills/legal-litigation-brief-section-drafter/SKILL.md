...
1. Load the project legal profile → case theory, house style.
...
Two rules that govern every citation and every quotation in advocacy drafting. The canonical statement lives in the package's `project legal profile` shared guardrails; repeated here because this skill is the most common place the rule gets tested.
...
**Before the brief is filed (the consequential act — this skill drafts, but the gate runs at the filing step regardless of who triggers it):** Read `## Who's using this` in the project legal profile. If the Role is Non-lawyer:
