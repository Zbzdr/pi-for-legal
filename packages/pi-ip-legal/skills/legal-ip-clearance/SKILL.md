...
```
/skill:legal-ip-clearance "APEXLEAF for an outdoor apparel line, planned launch US + EU"
```
...
This is the loudest guardrail in the package. Under-calling a conflict is a
...
Before running clearance, read the project legal profile. Pull:
...
Read `## Available integrations` from the project legal profile:
...
Per the decision posture in the project legal profile:
...
- **Conclude a mark is clear.** Ever. The loudest guardrail in the package.
