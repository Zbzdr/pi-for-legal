...
Reviews the IP clauses in an agreement against the practice profile in the project legal profile. Flags assignment gaps, ownership ambiguity, license-scope issues, and IP warranty/indemnity problems. Produces a memo with per-clause findings, prioritized by risk, with suggested redline language where appropriate.

## Instructions

1. **Load the project legal profile.** If placeholders present, stop and prompt: "Run `/skill:legal-setup` first — I need to learn your practice profile before I can review IP clauses against it."
...
```
/skill:legal-ip-clause-review ~/Documents/vendor-sow.pdf
/skill:legal-ip-clause-review https://docs.google.com/document/d/...
/skill:legal-ip-clause-review
```
...
**Before reading the agreement, read the project legal profile.** If it is missing or still contains placeholders, stop and run `/skill:legal-setup`. The practice profile tells you:
...
**Escalation:** Per the project legal profile, assignment-scope gaps escalate to [approver].
```
