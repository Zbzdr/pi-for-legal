...
**Privacy review required?** [Yes — run `/skill:legal-privacy-pia-generation` /
No]
...
- **To privacy:** If personal data is involved, flag: "Run `/skill:legal-privacy-pia-generation [system name]` in parallel — the AIA doesn't substitute for a PIA."
