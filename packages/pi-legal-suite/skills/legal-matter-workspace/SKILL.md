...
- **update:** edit only the active matter `README.md`, `history.md`, `notes.md`, or files below its `sources/`, `research/`, and `work-product/` directories. Keep README current-state notes concise.
