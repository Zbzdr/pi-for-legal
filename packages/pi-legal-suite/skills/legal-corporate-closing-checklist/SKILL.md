---
name: legal-corporate-closing-checklist
...
1. Read `<dataDir>/corporate-legal/deals/[code]/closing-checklist.yaml` and use the modes below.
...
Lives at `<dataDir>/corporate-legal/deals/[code]/closing-checklist.yaml`. Structure:
...
handoff:
  ...
  severity: "[🔴 / 🟠 / 🟡 / 🟢 — carried from upstream, see severity-floor rule in project legal profile]"
...
**Before producing a "ready to close / all CPs satisfied" certification or closing memo:** Read `## Who's using this` in the project legal profile. If the Role is **Non-lawyer**:
