...
1. Read the project legal profile. Confirm regulatory footprint and use case registry are populated.
...
4. Extract requirements. Diff against current state in the project legal profile.
...
```
/skill:legal-ai-reg-gap-analysis "EU AI Act high-risk provisions"
```
...
(per the project legal profile — use case registry, vendor positions, impact assessment practices,
...
**We currently:** [what the project legal profile / AI policy / use case registry / assessment
practice shows]
...
**To regulatory-legal package, if the package is installed:** This skill is the manual
...
- It doesn't track regulatory changes proactively. It runs when you point it at a
  change. For proactive monitoring, see the `regulatory-legal` package, if the package is installed.
