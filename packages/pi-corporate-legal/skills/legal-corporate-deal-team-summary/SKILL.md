---
name: legal-corporate-deal-team-summary
...
- the project legal profile → Deal team briefing (cadence, format, what the business reads)
- `<dataDir>/corporate-legal/deals/[code]/deal-context.md` → deal lead, timeline
- Current findings from diligence-issue-extraction output

## Audience tiers

Per the project legal profile — what the business reads vs. what's for the file. Default tiers:
...
If this is a recurring brief (per the project legal profile cadence), lead with what changed:
